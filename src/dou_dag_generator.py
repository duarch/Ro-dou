...
class DouDigestDagGenerator:
    ...
    def persist_analytics(self, num_searches: int, specs: DAGConfig, **context) -> dict:
        ...
        id_execucao = hook.insert_execution(
            ...
            dh_logical_date=logical_date,
            dh_data_interval_start=getattr(dag_run, "data_interval_start", None),
            dh_data_interval_end=getattr(dag_run, "data_interval_end", None),
